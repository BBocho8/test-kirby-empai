  ...
  <div class="flex justify-center max-w-6xl px-8 mx-auto py-36">
    ...
    <div id="left-div" class="w-1/2">
      ...
      <div class="flex flex-col gap-4 pl-2 pr-16 my-4">
        ...
        <input type="text" placeholder="Your Company Name" class="px-3 py-3 text-white border border-white rounded bg-empaiBlack">
        <input type="text" placeholder="Your annual electricity consumption (inkWh)" class="px-3 py-3 text-white border border-white rounded bg-empaiBlack">
        <select name="industry" id="industry-select" class="px-3 py-3 text-white border border-white rounded bg-empaiBlack" aria-placeholder="Your Industry">
      ...
      <div class="pl-2 pr-16">
        ...
        <a href="#">
          <button class="flex items-center justify-center w-full px-4 py-3 mt-8 font-bold bg-white rounded text-empaiBlack ">
            <span>Discover your savings potential now</span>
    ...
    <div id="right-div" class="bg-[#2D3742] border border-primary p-8 rounded w-1/2 flex flex-col gap-2">
      ...
      <p class="text-xl text-white">Equivalent to <span class="font-bold">€987.726</span> based on</br>the current market electricity</br>price of €82.29/MWh</p>
      <a href="#">
        <button class="flex items-center justify-center px-4 py-2 mt-8 font-bold bg-transparent border rounded border-primary text-primary">
          <span>Ask for personalized demo</span>
        </button>
      </a>
    </div>
  </div>
